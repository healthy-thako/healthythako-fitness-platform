...
import { Star, MapPin, Heart, MessageSquare, CheckCircle, Award, Clock } from 'lucide-react';
...
const TrainerProfileCard: React.FC<TrainerProfileCardProps> = ({
  ...
  return (
    <Card className="group relative overflow-hidden bg-white hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-pink-200 rounded-xl sm:rounded-3xl hover:-translate-y-1 sm:hover:-translate-y-2">
      {/* Favorite Heart */}
      <Button
        variant="ghost"
        size="sm"
        ...
        <div className="bg-gradient-to-r from-gray-50 to-pink-50 rounded-xl sm:rounded-2xl p-3 sm:p-4 my-3 sm:my-4">
          <div className="text-center">
            <div className="flex items-baseline justify-center gap-1">
              <span className="text-lg sm:text-xl font-bold text-gray-900">৳{typeof profile.rate_per_hour === 'string' ? parseFloat(profile.rate_per_hour) : profile.rate_per_hour}</span>
